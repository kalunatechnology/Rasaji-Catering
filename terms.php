                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            ...
                            <p>Welcome to rasajicatering!</p>

                            <p>These terms and conditions outline the rules and regulations for the use of
                                rasajicatering's Website, located at rasaji.infinityfreeapp.com.</p>

                            <p>By accessing this website we assume you accept these terms and conditions. Do not
                                continue to use rasajicatering if you do not agree to take all of the terms and
                            ...
                            <p>We employ the use of cookies. By accessing rasajicatering, you agreed to use cookies in
                                agreement with the rasajicatering's Privacy Policy.</p>
                            ...
                            <p>Unless otherwise stated, rasajicatering and/or its licensors own the intellectual
                                property rights for all material on rasajicatering. All intellectual property rights are
                                reserved. You may access this from rasajicatering for your own personal use subjected to
                                restrictions set in these terms and conditions.</p>

                            <p>You must not:</p>
                            <ul>
                                <li>Republish material from rasajicatering</li>
                                <li>Sell, rent or sub-license material from rasajicatering</li>
                                <li>Reproduce, duplicate or copy material from rasajicatering</li>
                                <li>Redistribute content from rasajicatering</li>
                            </ul>

                            <p>This Agreement shall begin on the date hereof.</p>

                            <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                                information in certain areas of the website. rasajicatering does not filter, edit,
                                publish or review Comments prior to their presence on the website. Comments do not
                                reflect the views and opinions of rasajicatering,its agents and/or affiliates. Comments
                                reflect the views and opinions of the person who post their views and opinions. To the
                                extent permitted by applicable laws, rasajicatering shall not be liable for the Comments
                            ...
                            <p>rasajicatering reserves the right to monitor all Comments and to remove any Comments
                            ...
                            <p>You hereby grant rasajicatering a non-exclusive license to use, reproduce, edit and
                            ...
                            <p>We will approve link requests from these organizations if we decide that: (a) the link
                                ...
                                visibility of the hyperlink compensates the absence of rasajicatering; and (d) the link
                            ...
                            <p>If you are one of the organizations listed in paragraph 2 above and are interested in
                                linking to our website, you must inform us by sending an e-mail to rasajicatering.
                            ...
                            <p>No use of rasajicatering's logo or other artwork will be allowed for linking absent a
